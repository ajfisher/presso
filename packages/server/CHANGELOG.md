...
## [0.4.0](https://github.com/ajfisher/presso/compare/@ajfisher/presso-server-v0.3.0...@ajfisher/presso-server-v0.4.0) (2026-05-23)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @ajfisher/presso-create bumped from ^0.3.0 to ^0.4.0
    * @ajfisher/presso-export bumped from ^0.3.0 to ^0.4.0
    * @ajfisher/presso-runtime bumped from ^0.3.0 to ^0.4.0
